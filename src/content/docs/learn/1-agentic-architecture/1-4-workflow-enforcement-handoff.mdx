...
**Subagent-scoped hook:** Subagent নিজের frontmatter-এ hook লিখতে পারে। সব hook event সেখানে সমর্থিত, `PreToolUse` ও `PostToolUse` সহ, আর সেগুলো সেই কম্পোনেন্টের lifetime পর্যন্ত সীমিত — কেবল সেই subagent-এর tool call ধরে, coordinator বা অন্য subagent-এর নয়। এতে per-subagent policy এনফোর্স করা যায়; যেমন billing subagent-এর `PreToolUse` hook threshold-এর উপরে refund আটকায়, আর technical support subagent-এ সেই নিষেধ নেই।
...
## একাধিক উদ্বেগের রিকোয়েস্ট হ্যান্ডলিং
...
## Structured Handoff প্রোটোকল

এজেন্ট সমস্যা মেটাতে না পারলে মানুষের কাছে escalate করবে, আর সেই হ্যান্ডঅফ একটি কাঠামোবদ্ধ প্রোটোকল মানবে। কঠিন শর্ত: **মানুষের এজেন্টের হাতে conversation transcript থাকে না।** সে চ্যাট history স্ক্রল করে বুঝতে পারে না কী হয়েছে।
