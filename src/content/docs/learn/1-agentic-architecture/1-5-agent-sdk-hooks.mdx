...
Agent SDK hook এক সম্ভাব্যতাভিত্তিক সিস্টেমে ডিটারমিনিস্টিক আচরণ ঢোকায়। এরা মডেলের সিদ্ধান্ত আর বাস্তব জগতের ঠিক সীমানায় বসে, tool call ও ফল আটকে নিয়ে ব্যবসার নিয়ম খাটায় আর ডেটা নরমালাইজ করে। 1.4-এর enforcement spectrum মনে আছে? Hook-ই তার programmatic দিকটির বাস্তব রূপ।
...
**`PreToolUse`** টুল চলার আগে চলে (একে tool-call interception-ও বলা হয়)। বাইরে যাওয়া tool call আটকে নিয়ে সেটি block, modify বা বিকল্প ওয়ার্কফ্লোতে redirect করতে পারে। Hook block করার সিদ্ধান্ত নিলে টুল আর চলে না।
...
`PreToolUse` hook হলো 1.4-এ বর্ণিত prerequisite gate-এর বাস্তবায়ন-মেকানিজম। এটি বাইরে যাওয়া tool call আটকে নিয়ে ব্যবসার নিয়ম খাটায়:
