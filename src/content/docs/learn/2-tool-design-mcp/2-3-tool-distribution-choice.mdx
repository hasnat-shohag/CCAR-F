...
মডেল নিজে ঠিক করে টুল ডাকবে, নাকি টেক্সট ফেরাবে। সাধারণ পরিচালনায় ব্যবহার করুন, যেখানে tool call না-করার মতো অবস্থায় কথোপকথনমূলক উত্তর দিতে মডেলের নমনীয়তা দরকার।
...
মডেল **অবশ্যই** একটি টুল ডাকবে, কিন্তু কোনটি তা নিজে বাছবে। একাধিক schema থেকে নিশ্চিত structured output দরকার হলে ব্যবহার করুন — মডেল সর্বদা একটি tool call দেবে, কখনো সাধারণ টেক্সট নয়।
