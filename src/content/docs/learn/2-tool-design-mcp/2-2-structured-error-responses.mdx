...
```mermaid
flowchart TD
  E["tool call ব্যর্থ<br/>isError: true"] --> C{"errorCategory?"}
...
## Multi-agent সিস্টেমে error propagation
...
> একটি টুল গ্রাহক-লুকআপের পর খালি array ফেরাল। এজেন্ট তিনবার retry করল, তারপর মানুষকে escalate করল। বিশ্লেষণে দেখা গেল গ্রাহকের অ্যাকাউন্টই নেই। এই অপচয়ের মূল কারণ কোনটি?

<details>
	<summary>উত্তর দেখুন</summary>

	**সঠিক উত্তর:** টুলটি access failure আর valid empty result-এর পার্থক্য করে না, তাই এজেন্ট "কিছু মেলেনি"-কে retry-যোগ্য ব্যর্থতা ধরে নেয়।

	**কেন বাকিগুলো ভুল:**

	- *Retry সীমা বাড়িয়ে ৫ করা* — সমস্যা সীমায় নয়। অনুপস্থিত অ্যাকাউন্ট ৫ বারেও ফিরবে না, শুধু অপচয় বাড়বে।
	- *System prompt-এ কখনো customer lookup retry না করতে বলা* — তাহলে প্রতিটি সাময়িক ব্যর্থতা সঙ্গে সঙ্গে মানুষকে চলে যাবে; নিজে সারানোর সুযোগটুকু হারায়।
	- *Escalation threshold আরও ধৈর্যশীল করা* — এটিও ভুল স্তরে চিকিৎসা। মূল কারণ চিহ্নিত না করলে যত retry-ই হোক ফল একই।
