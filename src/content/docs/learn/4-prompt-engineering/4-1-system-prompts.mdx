...
প্রোডাকশন প্রম্পট ইঞ্জিনিয়ারিংয়ের সবচেয়ে বড় ভুল — অস্পষ্ট নির্দেশের উপর ভরসা। প্রোডাকশনের system prompt-এ model-কে বলতে হয় ঠিক কী ধরবে আর কী ধরবে না। এখানে মডেলের "রুচি" নয়, স্পষ্ট **decision boundary** লাগে।
