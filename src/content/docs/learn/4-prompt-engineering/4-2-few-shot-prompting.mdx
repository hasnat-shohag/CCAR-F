...
keywords:
  - term: few-shot examples
    bn: কাঙ্ক্ষিত input-output দৃষ্টান্ত কয়েকটি প্রম্পটে দেখানো, যাতে মডেল ফরম্যাট ও judgement অনুকরণ করে।
    tip: অসামঞ্জস্যপূর্ণ আউটপুটের প্রথম প্রতিকার — আরও নির্দেশ নয়, উদাহরণ।
  - term: reasoning in examples
    bn: শুধু input-output নয়, কেন সেই সিদ্ধান্ত নেওয়া হলো তার ব্যাখ্যাও উদাহরণে রাখা।
    tip: Reasoning থাকলে মডেল নীতি শেখে, কেবল হুবহু মিলিয়ে দেখা নয়।
  - term: ambiguous judgement call
    bn: একই ধরনের কেসে মডেল কখনো কঠোর, কখনো নরম শ্রেণিবিন্যাস করে — যেমন variable shadowing।
    tip: এমন কেসে সঠিক judgement-এর উদাহরণ দিন, reasoning-সহ।
  - term: empty/null field extraction
    bn: ডকুমেন্টে তথ্য থাকা সত্ত্বেও extraction-এ field খালি ফেরা, কারণ তথ্যটি অপ্রত্যাশিত গঠনে আছে।
    tip: টেবিলে চলে কিন্তু narrative paragraph-এ ফাঁকা এলে few-shot উদাহরণ দিন।
  - term: 2-4 targeted examples
    bn: দুইয়ের কম হলে প্যাটার্ন দাঁড়ায় না, চারটির বেশি হলে টোকেন নষ্ট হয় বিনা সুফলে।
    tip: উদাহরণগুলো হুবহু যে পরিস্থিতিতে সমস্যা হয়, সেদিকেই তাক করুন।
  - term: hallucination reduction
    bn: বিভিন্ন গঠনের extraction উদাহরণ দেখালে মডেল তথ্য বানানো কমায়।
    tip: মিশ্র format-এর ডকুমেন্টে টেবিলে ঠিক, narrative-এ বানানো — উদাহরণে দুটোই দেখান।
sources:
