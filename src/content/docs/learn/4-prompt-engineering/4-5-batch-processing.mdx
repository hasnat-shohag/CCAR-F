...
Workflow-এ mid-processing টুল চলানো দরকার হলে synchronous API ব্যবহার করতেই হবে। এই সীমাটি সরাসরি পরীক্ষার বিষয় — batch workflow-এ প্রসেসিংয়ের মাঝে বাইরের tool call দরকার হলে সেই ধাপের সঠিক উত্তর synchronous API।
