...
keywords:
  - term: information provenance
    bn: প্রতিটি দাবি কোথা থেকে এসেছে আর তাতে কতটা আস্থা রাখা উচিত, তা জানা।
    tip: বিশ্বাসযোগ্য research আউটপুট আর বিশ্বাসযোগ্য শোনা কল্পকাহিনির পার্থক্য এটিই।
  - term: structured claim-source mapping
    bn: প্রতিটি finding-এর সঙ্গে claim, source URL, document name, relevant excerpt ও publication date রাখা।
    tip: ঐচ্ছিক metadata নয় — চূড়ান্ত আউটপুট নির্দিষ্ট সোর্স পর্যন্ত টেনে নেওয়ার গঠনগত জামিন।
  - term: attribution loss during summarisation
    bn: Synthesis agent সংক্ষেপ করলে claim-source mapping মুছে যায়; "Investment grew significantly"-এর মতো কথা থাকে, অঙ্ক-সোর্স-তারিখ থাকে না।
    tip: Synthesis prompt-এ স্পষ্টভাবে mapping ধরে রাখার নির্দেশ না দিলে attribution হারায়।
  - term: conflict handling
    bn: দুই বিশ্বাসযোগ্য সোর্স ভিন্ন মান দিলে এক মান বাছার বদলে দুটোই attribution-সহ annotate করা।
    tip: এক মান বেছে নিলে তথ্য ধ্বংস হয় আর মিথ্যা নিশ্চয়তা তৈরি হয়; সিদ্ধান্ত পড়ুয়ার উপর ছাড়ুন।
  - term: temporal awareness
    bn: ভিন্ন publication/temporal তারিখ থেকেই ভিন্ন সংখ্যার ব্যাখ্যা মেলে — এটি বিরোধ নয়, প্রবণতা।
    tip: তারিখ structured output-এ রাখলে বৈধ trend-কে data quality সমস্যা ভেবে ভুল flag করা এড়ানো যায়।
  - term: content-appropriate rendering
    bn: আর্থিক ডেটা টেবিলে, সংবাদ গদ্যে, প্রযুক্তিগত finding structured list-এ দেখানো।
    tip: সব কনটেন্ট এক ফরম্যাটে চাপ দিলে পড়ার সহজতা ও বোঝাপড়া নষ্ট হয়।
  - term: contradicts intact analysis
    bn: বিরোধপূর্ণ মান পেলে analysis agent বিরোধ অমীমাংসিত রেখেই explicit annotation-সহ কাজ শেষ করে।
    tip: বিরোধ মেটানোর সিদ্ধান্ত coordinator বা পড়ুয়ার, analysis agent-এর নয়।
sources:
