...
keywords:
  - term: explicit human request
    bn: গ্রাহক স্পষ্টভাবে মানুষ/এজেন্টের কাছে যেতে চাওয়া।
    tip: সঙ্গে সঙ্গে escalate করুন — আগে সমাধানের চেষ্টা করবেন না; এটি ব্যতিক্রমহীন নিয়ম।
  - term: policy exception or gap
    bn: অনুরোধ লিখিত নীতির বাইরে, বা নীতি ওই পরিস্থিতি নিয়ে নীরব।
    tip: Gap আর violation আলাদা — violation-এর উত্তর নীতিতেই লেখা আছে (না), gap-এ মানুষের বিচার দরকার।
  - term: inability to make meaningful progress
    bn: যত্নসহ চেষ্টার পরও agent এগোতে পারছে না — টুল ব্যর্থ, অ্যাক্সেস নেই, বা engineering হস্তক্ষেপ দরকার।
    tip: Catch-all, তবে কেবল সত্যিকারের চেষ্টার পরে; "হয়তো পারব না" যথেষ্ট নয়।
  - term: sentiment-based escalation
    bn: গ্রাহকের ক্ষোভ বা negative sentiment দেখে escalate করা।
    tip: অনির্ভরযোগ্য — ক্ষোভ কেসের জটিলতার সঙ্গে সম্পর্কহীন; সরল দেরিতে-delivery-তে চটে থাকা গ্রাহকও সহজ।
  - term: self-reported confidence escalation
    bn: মডেলের জানানো ১–১০ confidence threshold-এর নিচে নামলে escalate করা।
    tip: অনির্ভরযোগ্য — কঠিন কেসে মডেল আত্মবিশ্বাসী, সহজ কেসে দ্বিধায় থাকে।
  - term: ambiguous customer matching
    bn: একটি search query-তে একাধিক customer record মিলে যাওয়া, যেমন তিনটি "John Smith"।
    tip: Heuristic-এ একটি বাছবেন না; email, phone বা order number চেয়ে স্পষ্ট করুন।
  - term: explicit escalation criteria
    bn: System prompt-এ কখন escalate আর কখন নিজে সমাধান, তা few-shot উদাহরণসহ লেখা।
    tip: Classifier বা sentiment analysis-এর মতো অবকাঠামোর আগে proportionate প্রথম পদক্ষেপ।
sources:
