...
**মূল ধারণা:** Path-scoped rule root CLAUDE.md-এর চেয়ে বেশি token-সাশ্রয়ী, কারণ কেবল মেলে এমন ফাইল এডিট করলেই load হয়। এতে অপ্রাসঙ্গিক কনটেক্সট কমে আর মডেল বর্তমান কাজে যে নিয়মগুলো আসলেই খাটে সেগুলোতেই মনোযোগ দেয়। বহু convention-শ্রেণির বড় প্রজেক্টে এই লাভ উল্লেখযোগ্য।
...
> একটি কোডবেসে ৫০+ directory জুড়ে source ফাইলের পাশেই test ফাইল রয়েছে (যেমন `Button.tsx`-এর পাশে `Button.test.tsx`)। টিম চায় অবস্থান যাই হোক সব test একই convention মানুক। সবচেয়ে রক্ষণাবেক্ষণযোগ্য উপায় কোনটি?

<details>
	<summary>উত্তর দেখুন</summary>

	**সঠিক উত্তর:** `.claude/rules/`-এ `paths: ["**/*.test.tsx", "**/*.test.ts"]` frontmatter-সহ একটি rule ফাইল বানানো।

	**কেন বাকিগুলো ভুল:**

	- *Root CLAUDE.md-তে সব test convention যোগ করা* — Root-এর প্রতিটি নিয়ম প্রতি সেশনে টোকেন খায়, প্রাসঙ্গিক হোক বা না হোক।
	- *Test ফাইল থাকা প্রতিটি directory-তে আলাদা CLAUDE.md* — ৫০+ কপি রাখলে যেকোনো পরিবর্তনে drift অনিবার্য।
	- *Convention-সহ একটি skill বানিয়ে test লেখার আগে সেটি ডাকতে বলা* — Always-on convention-এর উত্তর rules, skill নয়; মানুষের মনে রাখার উপর নির্ভর করা ভঙ্গুর।
